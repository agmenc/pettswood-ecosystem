...
function WizzyWig(saver, editableElements) {
    ...
    new DragAndDrop({
        $draggableElements: $(WizzyWig.draggableElements),
        $droppableElements: $(WizzyWig.droppableElements)
    });
}

WizzyWig.editableElements = "td, h1, h2, p";
WizzyWig.draggableElements = "table, h1, h2, p";
WizzyWig.droppableElements = WizzyWig.editableElements + ", tr, table";
...
WizzyWig.console = '<div class="middleFixed"><div id="wizzywigConsole"><div class="left spaced" style="margin-top: 20px; ">' + WizzyWig.saveButton + WizzyWig.helpButton + '</div>' + WizzyWig.simpleConcept + WizzyWig.multiRowConcept + WizzyWig.clearDiv + '</div></div>';
