...
WizzyWig.console = '<div class="middleFixed"><div id="wizzywigConsole"><div class="left spaced">' + WizzyWig.saveButton + WizzyWig.helpButton + '</div>' + WizzyWig.simpleConcept + WizzyWig.multiRowConcept + WizzyWig.clearDiv + '</div></div>';
