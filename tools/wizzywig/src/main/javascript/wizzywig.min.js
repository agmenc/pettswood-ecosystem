...
encodeURIComponent(b.contents());window.open(c,"Save");a.stopPropagation();a.preventDefault();return!1}};function StyleCopier(a,b){var d=$.map(b,function(b){return{styleName:b,styleValue:a.css(b)}});this.apply=function(a){$.each(d,function(b,d){a.css(d.styleName,d.styleValue)})}};function TableEditor(a){function b(){k?k=!1:$("#wizzywigTableEditor").hide()}function d(a,b){var c=middle(a),d=$("#wizzywigTableEditor").outerHeight();$("#wizzywigTableEditor").css("top",c-d/2);$("#wizzywigTableEditor").css("left",right(b)+10)}function c(){k=!0}function g(){k=!1}function h(){$("body").append(TableEditor.console);$("#wizzywigTableEditor").hide();$("#wizzywigTableEditor .copyTable").click(i(o));$("#wizzywigTableEditor .addColumn").click(i(p));$("#wizzywigTableEditor .add.row").click(i(q));
$("#wizzywigTableEditor .deleteTable").click(i(e));$("#wizzywigTableEditor .deleteColumn").click(i(r));$("#wizzywigTableEditor .deleteRow").click(i(s));$("#wizzywigTableEditor").focus(function(){$("#wizzywigTableEditor").show()});$("#wizzywigTableEditor button").mouseenter(c);$("#wizzywigTableEditor button").mouseleave(g)}function i(a){return function(){a();b()}}function e(){f.remove()}function o(){var b=f.clone();b.find("td").each(function(){a.bless($(this))});f.after(b)}function q(){var b=j.parent(),
c=b.clone();c.children().each(function(){a.bless($(this))});b.after(c)}function s(){j.parent().remove();exists(f.find("td"))||f.remove()}function p(){l(function(b){b.after(a.bless(b.clone()))});d(j,f)}function r(){l(function(a){a.remove()})}function l(a){var b=j.parent().children().index(j);f.find("tr").filter(function(){return!$(this).hasClass("fixture")}).each(function(){a($($(this).children("td").get(b)))})}function m(a){return 0==a.length?"":"<tr>"+n(a.head())+"</tr>"+m(a.tail())}function n(a){return""==
a?"":("1"==a.head()?'<td class="change"></td>':"<td></td>")+n(a.tail())}var j,f,k=!1;this.edit=function(a){var c=a.parents("table").first();exists(c)&&(exists($("#wizzywigTableEditor"))||h(),j=a,f=c,$("#wizzywigTableEditor").show(),d(a,c));a=a.find("input.inputter").first();exists(a)&&a.blur(b)};TableEditor.affectColumn=["01000","01000","01000","01000"];TableEditor.affectRow=["00000","11111","00000","00000"];TableEditor.copyTableButton='<button class="copyTable clear right">Copy Table</button>';TableEditor.addRowButton=
'<div class="holder clear right">\n<table class="add row">\n'+m(TableEditor.affectRow)+"</table>\n</div>\n";TableEditor.addColumnButton='<button class="addColumn clear right">Add Column</button>';TableEditor.deleteTableButton='<button class="deleteTable clear left">Delete Table</button>';TableEditor.deleteRowButton='<button class="deleteRow clear left">Delete Row</button>';TableEditor.deleteColumnButton='<button class="deleteColumn clear left">Delete Column</button>';TableEditor.add='<div class="spaced left">'+
TableEditor.copyTableButton+TableEditor.addRowButton+TableEditor.addColumnButton+"</div>";TableEditor.deleteCells='<div class="spaced left">'+TableEditor.deleteTableButton+TableEditor.deleteRowButton+TableEditor.deleteColumnButton+"</div>";TableEditor.console='<div id="wizzywigTableEditor" class="console tablet">'+TableEditor.add+TableEditor.deleteCells+"</div>"};function asPlain(a){return a[0]}function exists(a){if("undefined"===typeof a)return!1;if(!a.size)throw"Not a JQuery object";return 0<a.size()}var tail=function(){return this.slice(1)};String.prototype.head=function(){return this.slice(0,1)};String.prototype.tail=tail;Array.prototype.head=function(){return this[0]};Array.prototype.tail=tail;function whole(a){return parseInt(a.toFixed(0))}function middle(a){return a.offset().top+whole(a.outerHeight()/2)}function left(a){return a.offset().left}
function right(a){return a.offset().left+a.outerWidth()}function WizzyWig(a,b,d,c,g){function h(a){a.addClass("editable");a.click(function(){exists(a.find("input.inputter"))||new Inputter(a);d.edit(a)});return a}g.delegate(h);$(a).each(function(){h($(this))});c.makeMoveable($(WizzyWig.draggableElements));c.makeDropTarget($(WizzyWig.draggableElements));$("body").append(WizzyWig.console);$("#wizzywigConsole .save").click(function(a){b.save(a)});c.makeCopyable($("#wizzywigConsole table"))}
